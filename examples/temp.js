...
;
;
((("undefined" == typeof(module)))?(window.module = {},window.module.export = {}):(null));
;
...
(function (for$00$loop$00$count,__r79){return ((function() { var __r80; while ((loop$00$count > 0)) __r80 = (__r79 = ((console.log)(("for-loop-count: " + for$00$loop$00$count))),for$00$loop$00$count = (for$00$loop$00$count - 1),__r79); return __r80;})());})(10,false);
